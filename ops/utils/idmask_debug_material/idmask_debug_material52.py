...
def onehot_8_1_node_group(node_tree_names: dict[typing.Callable, str]):
    ...
    _5_socket_1.default_input = 'VALUE'
    _5_socket_1.structure_type = 'AUTO'
    ...
    _6_socket_1.default_input = 'VALUE'
    _6_socket_1.structure_type = 'AUTO'
    ...
    _7_socket_1.default_input = 'VALUE'
    _7_socket_1.structure_type = 'AUTO'
    ...
    _8_socket_1.default_input = 'VALUE'
    _8_socket_1.structure_type = 'AUTO'
    ...
    onehot_8_1.nodes["Reroute"].width  = 100.0
    ...
    onehot_8_1.nodes["Reroute.001"].width  = 100.0
    ...
    onehot_8_1.nodes["Reroute.002"].width  = 100.0
    ...
    onehot_8_1.nodes["Reroute.003"].width  = 100.0
    ...
    onehot_8_1.nodes["Reroute.004"].width  = 100.0
    ...
    onehot_8_1.nodes["Reroute.005"].width  = 100.0
    ...
    onehot_8_1.nodes["Reroute.006"].width  = 100.0
...
def debug_idmask_1_node_group(node_tree_names: dict[typing.Callable, str]):
    ...
    pattern_mask_socket.default_input = 'VALUE'
    pattern_mask_socket.structure_type = 'AUTO'
    ...
    math.use_clamp = True
    # Value_001
    math.inputs[1].default_value = 0.20000000298023224
    ...
    debug_idmask_1.nodes["Reroute"].width  = 100.0
    debug_idmask_1.nodes["Reroute"].height = 100.0

    debug_idmask_1.nodes["Reroute.001"].width  = 100.0
...
def shader_nodetree_node_group(node_tree_names: dict[typing.Callable, str]):
    ...
    idmask_debug_material.alpha_threshold = 0.5
    idmask_debug_material.line_priority = 0
    idmask_debug_material.max_vertex_displacement = 0.0
    idmask_debug_material.metallic = 0.0
    idmask_debug_material.paint_active_slot = 0
    idmask_debug_material.paint_clone_slot = 0
    idmask_debug_material.pass_index = 0
    idmask_debug_material.refraction_depth = 0.0
    idmask_debug_material.roughness = 0.4000000059604645
    idmask_debug_material.show_transparent_back = True
    idmask_debug_material.specular_intensity = 0.5
    idmask_debug_material.use_backface_culling = False
    idmask_debug_material.use_backface_culling_lightprobe_volume = False
    idmask_debug_material.use_backface_culling_shadow = False
    idmask_debug_material.use_preview_world = False
    idmask_debug_material.use_raytrace_refraction = False
    idmask_debug_material.use_screen_refraction = False
    idmask_debug_material.use_sss_translucency = False
    idmask_debug_material.use_thickness_from_shadow = False
    idmask_debug_material.use_transparency_overlap = True
    idmask_debug_material.use_transparent_shadow = True
    idmask_debug_material.blend_method = 'HASHED'
    idmask_debug_material.displacement_method = 'BUMP'
    idmask_debug_material.preview_render_type = 'SPHERE'
    idmask_debug_material.surface_render_method = 'DITHERED'
    idmask_debug_material.thickness_mode = 'SPHERE'
    idmask_debug_material.volume_intersection_method = 'FAST'
    idmask_debug_material.specular_color = (1.0, 1.0, 1.0)
    idmask_debug_material.diffuse_color = (0.800000011920929, 0.800000011920929, 0.800000011920929, 1.0)
    idmask_debug_material.line_color = (0.0, 0.0, 0.0, 0.0)
    ...
    principled_bsdf.subsurface_method = 'RANDOM_WALK_LEGACY'
    principled_bsdf.panel_states[0].is_collapsed = True
    principled_bsdf.panel_states[1].is_collapsed = True
    principled_bsdf.panel_states[2].is_collapsed = True
    ...
    # Subsurface Scale
    principled_bsdf.inputs[11].default_value = 0.05000000074505806
    ...
    if "idmask_channel-0" in bpy.data.images:
        image_texture.image = bpy.data.images["idmask_channel-0"]
    ...
    if "idmask_channel-1" in bpy.data.images:
        image_texture_001.image = bpy.data.images["idmask_channel-1"]
    ...
    if "idmask_channel-2" in bpy.data.images:
        image_texture_002.image = bpy.data.images["idmask_channel-2"]
    ...
    if "idmask_channel-3" in bpy.data.images:
        image_texture_003.image = bpy.data.images["idmask_channel-3"]
    ...
    if "idmask_channel-4" in bpy.data.images:
        image_texture_004.image = bpy.data.images["idmask_channel-4"]
    ...
    if "idmask_channel-5" in bpy.data.images:
        image_texture_005.image = bpy.data.images["idmask_channel-5"]
    ...
    if "idmask_channel-6" in bpy.data.images:
        image_texture_006.image = bpy.data.images["idmask_channel-6"]
    ...
    if "idmask_channel-7" in bpy.data.images:
        image_texture_007.image = bpy.data.images["idmask_channel-7"]
    ...
    if "idmask_channel-9" in bpy.data.images:
        image_texture_008.image = bpy.data.images["idmask_channel-9"]
